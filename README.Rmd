...
matplot(results$time[1:10000], cbind(results$S[1:10000], results$I[1:10000], results$R[1:10000]), type = "l", col = sir_col, lty = 1, xlab="time", ylab="S, I, R", main = "SIR model, single run, N = 10,000, dt = 0.01")
 title("SIR model, single run, N = 10,000, dt = 0.01", line = -2)
...
for (j in count)
  {
    ...
    title("SIR model, 100 runs, N = 10,000, dt = 0.01", line = -2)
    legend("topright", inset = 0.05, lwd = 1, col = sir_col, legend = c("S", "I", "R"))
}
```
