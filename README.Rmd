...
This is a basic example which shows you how to solve a common problem. Th model is run for 10000 iterations, time step 0.01

```{r echo=FALSE, fig,cap = "SIR simulation, N= 10000, dt = 0.01"}
dt <- 0.01
results <- sirstochastic::themodel(dt)

sirstochastic:::displaythemodel(results)
#plot(results)
```
