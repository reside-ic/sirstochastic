...
knitr::include_graphics("man/figures/README-unnamed-chunk-3-1.png")
```
...
```{r echo=FALSE, fig.align='center', fig.cap='SIR simulation run once, N = 10,000 and dt = 0.01', out.width='0.95\\linewidth', fig.pos='H'}
options(warn = - 1) 
dt <- 0.01
